...
connection = sqlite3.connect("movies_watchlist.db")
...
def get_watched_movies(username):
    with connection:
        cursor = connection.cursor()
        cursor.execute(SELECT_WATCHED_MOVIES, (username,)) #usar a virgula no final (depois de colocar o valor) para que vire uma tupla e funcione no código
        return cursor.fetchall()